...
- A new photo goes into `public/` as WebP at the lowest quality that still scores SSIMULACRA2 85 or more against the original at full width (libjxl's tool; 85 means no visible difference when flipping between the two at 1:1). Full width because next/image serves the whole file to a 2x screen before re-encoding it. The hero was done this way on 2026-09-26: q92, 2.7 MB to 721 kB.
